...
MyApp.loginPage = SC.Page.design({
  ...
  panel: SC.PanelPane.create({
    ...
    contentView: SC.View.design({
      ...
      rememberMe: SC.View.design({
        ...
        field: SC.SelectButtonView.design({
          ...
          objects: [
            {name:'_For 3 Seconds'.loc(), value:'3seconds'},
            {name:'_Until the browser is closed'.loc(), value:'closeBrowser'},
            {name:'_For 1 year'.loc(), value:'1year'}
            ],
          nameKey: 'name',
          valueKey: 'value',
    ...
    focus: function() {
      this.contentView.username.field.becomeFirstResponder();
    }
